...
public class Renderer {
    ...
    private int LocEmissive;
    private BodyRenderer lightSource;
    private Vector3f lightColor = new Vector3f(1.0f, 0.93f, 0.72f);
    ...
    private void initUniforms() {
        ...
        LocEmissive = glGetUniformLocation(shaderProgramId, "emissive");
    }
    ...
    private void uploadCameraUniforms() {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            FloatBuffer lightColorBuffer = stack.mallocFloat(3);
            getLightPosition().get(lightPos);
            ...
            glUniform3fv(LocLightColor, lightColorBuffer);
        }
    }
    ...
    private void uploadModelUniform(BodyRenderer body) {
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            glUniform1i(LocEmissive, body.emissive ? 1 : 0);
        }
    }
    ...
    public void setLightSource(BodyRenderer lightSource) {
